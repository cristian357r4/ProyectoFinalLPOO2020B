...
class PruebasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prueba" do
    assert_difference('Prueba.count') do
      post pruebas_url, params: { prueba: { primer: @prueba.primer, segundo: @prueba.segundo, tercer: @prueba.tercer } }
    end
  ...
  test "should update prueba" do
    patch prueba_url(@prueba), params: { prueba: { primer: @prueba.primer, segundo: @prueba.segundo, tercer: @prueba.tercer } }
