...
class PacientesTest < ApplicationSystemTestCase
  ...
  test "creating a Paciente" do
    ...
    fill_in "Civil", with: @paciente.civil
    fill_in "Domicilio", with: @paciente.domicilio
    fill_in "Edad", with: @paciente.edad
    fill_in "Imc", with: @paciente.imc
    fill_in "Nss", with: @paciente.nss
    fill_in "Peso", with: @paciente.peso
    fill_in "T sangre", with: @paciente.t_sangre
